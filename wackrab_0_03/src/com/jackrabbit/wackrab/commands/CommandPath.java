...
public class CommandPath implements CommandExecutor{
	...
	public CommandPath(Main main, boolean isPathFrom) {
	 ...
	 public static boolean ShowPath(Main main, Player player, WorldRelation from, WorldRelation to) 
	 {
		 ...
		 WorldRelation worldRel = main.hierachieWorlds.getWorldRelationByName(from.worldName);
		...
		// }
		 ...
		 message += "" + from.worldName + " --> "+ to.worldName;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		 if (label.equalsIgnoreCase("path") || label.equalsIgnoreCase("pathfrom")) {
			 ...
			 // paths
			 return ShowPath(main, ((Player) sender).getPlayer(), worldFrom, worldTo);
