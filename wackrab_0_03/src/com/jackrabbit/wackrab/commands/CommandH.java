...
public class CommandH implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        helpMessage += " = ~ = ~ =   H E L P   /h   = ~ = ~ =                     "; helpMessage += ChatColor.LIGHT_PURPLE; helpMessage += "\n";
        helpMessage += "Wackrab Commands:                                         "; helpMessage += ChatColor.GOLD; helpMessage += "\n";
        helpMessage += "  /world : show the current world informations.           "; helpMessage += ChatColor.GOLD; helpMessage += "\n";
        helpMessage += "  /path  : [TOWORLD] show itinerary from 2 worlds.        "; helpMessage += ChatColor.GOLD; helpMessage += "\n";
        helpMessage += "  /pathfrom  : [FROMWORLD] [TOWORLD]                      "; helpMessage += ChatColor.GOLD; helpMessage += "\n";
        helpMessage += "  /howto  : show Teleporters Functionnality & Recipe      "; helpMessage += ChatColor.GOLD; helpMessage += "\n";
